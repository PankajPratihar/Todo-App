  ...
  return (
    ...
    <Navbar/>
       ...
       <h1 className='font-bold text-center text-3xl'>iTask - Manage your todos at one place</h1>
        ...
        <input className='my-4' onChange={toggleFinished} type='checkbox' checked={finished}   /> 
        ...
        <div className="todos">
          ...
          return (finished || !item.isCompleted) && <div key={item.id}  className="todo flex md:w-[50%] my-3 justify-between">
